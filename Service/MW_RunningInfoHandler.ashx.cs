...
{
    /// <summary>
    /// MW_RunningInfoHandler 的摘要说明
    /// </summary>
    public class MW_RunningInfoHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (method == "get")
            {
                ...
                cmd.CommandText = "SP_GetRunningInfo";
                ...
                var obj = new {RunningInfo = Kit.ToDicList(ds.Tables[0])};
